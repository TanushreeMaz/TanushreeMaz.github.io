...
### 🔹 Healthcare Analysis
Explored patient data to uncover patterns in treatment costs, outcomes, and resource utilization. Focused on improving efficiency and identifying high-risk cases.

### 🔹 Restaurant Tips Analysis
Performed exploratory data analysis on tipping behavior using factors like time, gender, and group size. Derived insights into customer patterns and service impact.
